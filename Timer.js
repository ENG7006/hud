...
Timer.prototype = {
  ...
  // because getPrettySeconds() returns a string, this function will also return a string
  ...
  // forces numbers to a string by prepending a colon as a string, as part of the mm:ss representation
